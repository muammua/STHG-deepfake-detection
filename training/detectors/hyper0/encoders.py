...
from . import hyp_layers
from . import math_utils as pmath
...
class Encoder(nn.Module):
    ...
    def encode(self, data):
        ...
        hyperbolic_hypergraph_n_f = self.hypergraph_layers.forward(hypergraph_input)
                        
        return hyperbolic_hypergraph_n_f
